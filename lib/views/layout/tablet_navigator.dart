...
class TabletNavigator extends StatefulWidget {
  const TabletNavigator({
    super.key,
  });

  @override
  State<TabletNavigator> createState() => _TabletNavigatorState();
}

class _TabletNavigatorState extends State<TabletNavigator> {
