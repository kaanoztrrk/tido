...
import '../create_task/widget/priority_picker.dart';
import '../create_task/widget/title_sections.dart';
...
class _TaskEditViewState extends State<TaskEditView> {
  ...
  void initState() {
    ...
    priority = widget.task.priority; // Set initial priority
  }
              ...
              onTap: () async {
                if (titleController.text.isEmpty) {
                  ...
                  final updatedTask = TaskModel(
                    ...
                    taskTime: _selectedDateTime ?? widget.task.taskTime,
                    files: selectedFiles.isEmpty
                        ? widget.task.files
                        : selectedFiles,
                    priority: priority,
                  );
                  ...
                  ViSnackbar.showSuccess(
                      context, AppLocalizations.of(context)!.update_task);
                  context.pop();
